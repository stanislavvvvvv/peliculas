...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Pelicula modificar1 = context.getBean(Pelicula.class);
		...
		Pelicula modificar2 = context.getBean(Pelicula.class);
